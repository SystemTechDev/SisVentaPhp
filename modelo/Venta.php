    ...
    function insertar($venta){
        $sql = "INSERT INTO 
                venta(idventa, fecha, idcliente, idtipocomprobante, serie, correlativo,
                    ...
                    guiaremision, ordencompra, modalidad, tipocontrato, tiempocuotas, tiempoentrega, idusuario, estado) 
        ...
        $parametros = array(
            ...
            ":tipocontrato"     =>$venta["tipocontrato"],
            ":tiempocuotas"     =>$venta["tiempocuotas"],
            ":tiempoentrega"    =>$venta["tiempoentrega"], 
    ...
    function actualizar($venta){
        $sql = "UPDATE venta 
                SET fecha=:fecha, idcliente=:idcliente, idtipocomprobante=:idtipocomprobante,
                    ...
                    guiaremision=:guiaremision, ordencompra=:ordencompra, modalidad=:modalidad, tipocontrato=:tipocontrato, tiempocuotas=:tiempocuotas, tiempoentrega=:tiempoentrega, idusuario=:idusuario, estado=:estado 
