<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("SYSTEMKEL SAC")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,utf8_decode("RUC: 10751237875"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("Jr Ucayali Mz E Lt 10, Boqueron - Padre Abad - Ucayali"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("Teléfono: 985171277"),0,'C',false);
    $pdf->MultiCell(0,5,utf8_decode("Email: kelvinfabian98@gmail.com"),0,'C',false);
    ...
    $pdf->MultiCell(0,4,utf8_decode("Nombre de producto a vender"),0,'C',false);
    $pdf->Cell(10,4,utf8_decode("5"),0,0,'C');
    $pdf->Cell(19,4,utf8_decode("$10 USD"),0,0,'C');
    $pdf->Cell(19,4,utf8_decode("$0.00 USD"),0,0,'C');
    $pdf->Cell(28,4,utf8_decode("$70.00 USD"),0,0,'C');
    $pdf->Ln(4);
    ...
    $pdf->MultiCell(0,4,utf8_decode("Nombre de producto a vender"),0,'C',false);
    $pdf->Cell(10,4,utf8_decode("9"),0,0,'C');
    $pdf->Cell(19,4,utf8_decode("$10 USD"),0,0,'C');
    $pdf->Cell(19,4,utf8_decode("$0.00 USD"),0,0,'C');
    $pdf->Cell(28,4,utf8_decode("$70.00 USD"),0,0,'C');
    $pdf->Ln(4);
