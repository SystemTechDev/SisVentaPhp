...
$emisor = $objEmpresa->consultarEmpresa(1);
...
$pdf->Image("../../imagenes/logo.png",50,2,28,28);
...
$pdf->Cell(100,6,"MODALIDAD DE TRABAJO:",0,0,'L',0);
$pdf->SetXY(155,50);
$pdf->SetFont('Arial','',8);
$pdf->Cell(80,6,$venta['modalidad'],0,1,'L',0);

$pdf->SetXY(115,55);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(100,6,"TIPO DE CONTRATO:",0,0,'L',0);
$pdf->SetXY(145,55);
$pdf->SetFont('Arial','',8);
$pdf->Cell(80,6,$venta['tipocontrato']."-".$venta['tiempocuotas'],0,1,'L',0);

$pdf->SetXY(115,60);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(100,6,"TIEMPO DE ENTREGA:",0,0,'L',0);
$pdf->SetXY(147,60);
$pdf->SetFont('Arial','',8);
$pdf->Cell(80,6,$venta['tiempoentrega'],0,1,'L',0);
